...
<!-- Mirrored from mimity29.netlify.com/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Sep 2017 17:29:38 GMT -->
...
<head>
    ...
    <title>404 Not Found - Mimity</title>
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <ul class="list-inline pull-right">
              <li class="hidden-xs"><a href="faq.html"><i class="fa fa-question-circle"></i> Help</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 logo">
            <a href="index-2.html"><img alt="Logo" src="images/logo-teal.png" class="img-responsive" data-text-logo="Mimity Online Shop" /></a>
          </div>
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-cart">
              ...
              <div class="text-center">
                  <div class="btn-group" role="group" aria-label="View Cart and Checkout Button">
                    <a href="cart.html" class="btn btn-default btn-sm" type="button"><i class="fa fa-shopping-cart"></i> View Cart</a>
                    <a href="checkout.html" class="btn btn-default btn-sm" type="button"><i class="fa fa-check"></i> Checkout</a>
                  </div>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-12 text-center">
          ...
          <div class="btn-group m-t-2 m-b-3" role="group" aria-label="Default button group">
            ...
            <a href="index-2.html" class="btn btn-theme"><i class="ace-icon fa fa-home"></i> Home</a>
          </div>
