        ...
        <div class="col-lg-12">
            <div class="box DARK data-table-box">
                <header>
                    ...
                    <h5>Center Spare Parts Stock</h5>
                    <div class="toolbar">
                        <ul class="nav">
                                    ...
                                    foreach ($results as $result) {
                                        ...
                                        <tr class="entity-details '.$color.' data-id="'.$result['id'].'" data-entity="spare">
                                            ...
                                            <td>
                                                ...
                                                <a target="_blank" href="/BestWebs?module=inventory-store&mode=out-add&type=new&stock=old&spare='.$result['id'].'" class="btn btn-circle btn-line btn-warning " title="View Old Stock Transactions"><i class=" icon-list"></i></a>
                                            </td>
                                        </tr>
                                        ';
                                    }
