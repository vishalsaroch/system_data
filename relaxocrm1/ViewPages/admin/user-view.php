            ...
            <div class="box dark data-table-box">
                ...
                <div id="box-1" class="accordion-body collapse in body">
                    <table class="table table-bordered table-hover wide-table data-table">
                        ...
                        <tbody>
                            <?php
                                if ($results = $function->getArray_users()) {
                                    foreach ($results as $result) {
                                        ...
                                        echo "
                                        <tr class='entity-details $color' data-id='$result[id]' data-entity='user'>
                                            <td>
                                                <a href='javascript:void(0);' class='btn-action' data-action='details'>$result[name]<br>[$result[code]]</a>
                                            </td>
                                            <td>
                                                <a href='tel:$result[mobile]'>$result[mobile]</a><br><a href='mailto:$result[email]'>$result[email]</a>
                                            </td>
                                            <td class='entity-details' data-id='$result[center_id]' data-entity='center'>
                                            ...
                                            <td>
                                                ...
                                                <a href='javascript:void(0);' class='btn btn-danger btn-circle btn-line btn-action' data-action='reset' title='Reset Password and SMS'><i class='icon-refresh'></i></a>
                                                $action
