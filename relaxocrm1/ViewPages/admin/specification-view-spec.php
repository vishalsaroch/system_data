            ...
            <div class="box DARK data-table-box">
                ...
                <div id="box-1" class="accordion-body collapse in body">
                    <table class="table table-bordered table-hover wide-table data-table">
                        ...
                        <tbody>
                            <?php
                                if ($results = $function->getArrayOptions_All_Table('client_specsheet', array('spec_heading heading', 'spec spec', 'specsheet_id id'), ' ORDER BY ul_spec_heading ASC ')) {
                                    foreach ($results as $result) {
                                        echo '
                                        <tr class="entity-details" data-id="'.$result['id'].'" data-entity="specification">
