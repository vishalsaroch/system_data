            ...
            <div class="box DARK data-table-box">
                ...
                <div id="box-1" class="accordion-body collapse in body">
                    <table class="table table-bordered table-hover wide-table data-table">
                        ...
                        <tbody>
                            <?php
                                if ($results = $function->getArray_categories()) {
                                    foreach ($results as $result) {
                                        echo '
                                        <tr class="entity-details" data-id="'.$result['catId'].'" data-entity="category">
                                            <td><a href="#" class="btn-action" data-action="get-meta">'.$result['categoryName'].'</a></td>
