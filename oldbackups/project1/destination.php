...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(images/banner2.jpg)">
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<p>Listed here are some of the exclusive tour packages that we have customized for our valuable clients. Just glance through these packages, and plan your trip with us for a memorable touring experience.</p>
				</div>
			</div>
			<div class="row">
<?php
...
$sql = "SELECT packageName, image, packageDurationNight, packageDurationDay, destination1, destination2, destination3, destination4, destination5, destination6, destination7, destination8, destination9, destination10, packageCost from packages where destination1='".$loc."' or destination2='".$loc."' or destination3='".$loc."' or destination4='".$loc."' or destination5='".$loc."' or destination6='".$loc."' or destination7='".$loc."' or destination8='".$loc."' or destination9='".$loc."' or destination10='".$loc."'";
