			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<form action="destination.php" method="POST" class="fh5co-card-item">
						...
						<div class="fh5co-text">
							<h2 id="location1name">Delhi</h2>
							<p>Delhi now belonged to everyone who lived in it. But no one belonged to Delhi..</p>
							<input type="text" id="loc1" name="location" style="display: none;">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<form action="destination.php" method="POST" class="fh5co-card-item">
						...
						<div class="fh5co-text">
							<h2 id="location2name">Mumbai</h2>
							<p>Mumbai may not be my city. But it is my kind of city..</p>
							<input type="text" id="loc2" name="location" style="display: none;">
							<input type="submit" value="Explore" class="btn btn-primary">
						</div>
					</form>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6">
					<form action="destination.php" method="POST" class="fh5co-card-item">
						...
						<div class="fh5co-text">
							<h2 id="location3name">Uttarakhand</h2>
							<p>Uttarakhand : Dev Bhoomi : The Land of gods..</p>
							<input type="text" id="loc3" name="location" style="display: none;">
							<input type="submit" value="Explore" class="btn btn-primary">
						</div>
					</form>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<form action="destination.php" method="POST" class="fh5co-card-item">
						...
						<div class="fh5co-text">
							<h2 id="location4name">Jammu & Kashmir</h2>
							<p>If there is heaven on earth, it is here, it is here, it is here..</p>
							<input type="text" id="loc4" name="location" style="display: none;">
							<input type="submit" value="Explore" class="btn btn-primary">
						</div>
					</form>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<form action="destination.php" method="POST" class="fh5co-card-item">
						...
						<div class="fh5co-text">
							<h2 id="location5name">Kerala</h2>
							<p>In every walk with nature one receives far more than he seeks..</p>
							<input type="text" id="loc5" name="location" style="display: none;">
							<input type="submit" value="Explore" class="btn btn-primary">
						</div>
					</form>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<form action="destination.php" method="POST" class="fh5co-card-item">
						...
						<div class="fh5co-text">
							<h2 id="location6name">Rajasthan</h2>
							<p>The dessert has its holiness of silence, the crowd its holiness of conversation..</p>
							<input type="text" id="loc6" name="location" style="display: none;">
							<input type="submit" value="Explore" class="btn btn-primary">
						</div>
					</form>
				</div>
