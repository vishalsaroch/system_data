...
$(function() {
		$("#uploadForm").submit(function(e){
			...
			var urlkey2="http://sms.realkeeper.in/ComposeSMS.aspx?username=nakul&password=8585&sender=TXTSMS&to="+document.getElementById("hmobile").value.toString()+"&message=Hi "+document.getElementById("hname").value+", Awas Yojna me registration Karne ke liya dhaynvad apka ragistration pura ho chuka hai. Lucky draws will be announced on 31st March 2019. Registration number : 9876"+document.getElementById("aadhar98").value.substr(6)+"&priority=1&dnd=1&unicode=0";
			$.ajax({
