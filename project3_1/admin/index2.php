...
<body class="animsition">
    <div class="page-wrapper">
		...
		$("#theForm").submit(function(e){
			...
			{
				urlkey = "/project1/admin/upload.php";
			}
			...
			if(location.hostname=='localhost')
			{
				urlkey = "/project1/admin/fnametodb.php";
			}
			else if(location.hostname=='www.arkglobalholidays.co.in')
			{
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <span class="desc">Add new Package</span><br><br>
                                    <button class="au-btn au-btn-icon au-btn--green" type="button" onclick="window.location = './newpackage.html'">Add</button>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                ...
                <div class="section__content section__content--p30">
					...
					<?php
						...
						if($result->num_rows>0){
							echo "<div class='row'>
                            <div class='col-lg-12'>
                                <h2 class='title-1 m-b-25'>Leads 1 (Handled)</h2>
							...
							while($row = $result->fetch_assoc()){
								if($row["isHandled"]==1)
									...
									echo "<tr onclick='showcard(this);'><td>" . $row["packname"]. "</td><td>" . $row["date"]. "</td><td>" . $row["adultC"]."Adults & ".$row["childC"]." Childs</td><td>" . $row["descr"]."</td><td>" . $row["name"]."</td><td>" . $row["email"]. "</td><td>" . $row["country"]."</td><td>" . $row["city"]."</td><td>" . $row["contact"]."</td></tr>";
						...
						if($result->num_rows>0){
							echo "<div class='row'>
                            <div class='col-lg-12'>
                                <h2 class='title-1 m-b-25'>Leads 2 (Handled)</h2>
                                <div class='table-responsive table--no-card m-b-40'>
                                    <table class='table table-borderless table-striped table-earning'>
                                        <thead>
                                            <tr>
										...
										<tbody>";
							while($row = $result->fetch_assoc()){
								if($row["isHandled22"]==1)
								
									echo "<tr><td>" . $row["name"]. "</td><td>" . $row["email"]."</td><td>" . $row["contact"]."</td><td class='text-right'>" . $row["subject"]."</td><td class='text-right'>" . $row["message"]. "</td></tr>";
						...
						$sql = "select name, activities, destination, date, contact from bookmytrip";
						$result = $conn->query($sql);

						if($result->num_rows>0){
							echo "<div class='row'>
                            <div class='col-lg-12'>
                                <h2 class='title-1 m-b-25'>Leads 3 (Handled)</h2>
                                <div class='table-responsive table--no-card m-b-40'>
                                    <table class='table table-borderless table-striped table-earning'>
                                        <thead>
                                            <tr>
							...
							while($row = $result->fetch_assoc()){
								//if($row["isHandled3"]==1)
									...
									echo "<tr><td>" . $row["name"]. "</td><td>" . $row["activities"]."</td><td>" . $row["destination"]."</td><td class='text-right'>" . $row["date"]."</td><td class='text-right'>" . $row["contact"]. "</td></tr>";
