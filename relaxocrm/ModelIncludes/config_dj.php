...
define('CDN_ADMIN', 'https://crm.relaxoappliances.in/assets/admin');       //// No trailing edge slash ////
define('CDN_JS', 'https://crm.relaxoappliances.in/assets/js');             //// No trailing edge slash ////
define('CDN_CSS', 'https://crm.relaxoappliances.in/assets/css');           //// No trailing edge slash ////
