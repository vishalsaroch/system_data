...
CLASS Connection{
   ...
   function Connection(){
      try {
         $this->dbConn = new PDO("mysql:dbname=bestwebs_relaxocrm2;host=192.185.129.96;port={3306}", 'bestwebs_relaxou', 'Unkn@wn7P@ssw@rd', array(\PDO::MYSQL_ATTR_INIT_COMMAND => "SET time_zone = '+05:30'"));
