                    ...
                    <form class="ajax-form" action="" method="post" enctype="multipart/form-data" onsubmit="this.password.value = login_hash(this.password.value);this.cpassword.value = login_hash(this.cpassword.value);">
                        <div class="row">
                            <div class="col-xs-6 form-group">
                                ...
                                <select name="form[center_id]" class="form-control" id="center" required="" readonly="">
                                    <?php
                                      echo "<option selected value='$_SESSION[SESS__center_id]'>$_SESSION[SESS__center]</option>";
                                    ?>
                                </select>
                            </div>
                            <div class="col-xs-6 form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-xs-6">
                                <label>State </label>
                                <select class="form-control chzn-select" id="state" name="form[state]">
                            ...
                            <div class="col-sm-3 col-xs-6">
                                ...
                                <select class="form-control chzn-select" id="district" name="form[district]">
                                  <option value="">Select State First</option>
                                </select>
                            </div>
                            <div class="col-sm-3 col-xs-6 form-group">
                                <label>City</label>
                                <select class="form-control chzn-select" id="cities" name="form[city]">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 form-group">
                              ...
                              <input type="text" class="form-control" value="<?php echo $levels[1]; ?>" readonly="" name="designation" />
                            </div>
                        </div>
                        <div class="row">
