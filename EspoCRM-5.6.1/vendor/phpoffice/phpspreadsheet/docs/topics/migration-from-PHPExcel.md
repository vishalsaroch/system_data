# Migration from \PhpOffice\PhpSpreadsheet\Spreadsheet
...
The class `\PhpOffice\PhpSpreadsheet\Spreadsheet_Autoloader` was removed entirely and is replaced by composer
