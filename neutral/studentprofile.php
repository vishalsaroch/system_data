      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"> Student Attendance</h1>
        </div>
       </div>
      </div>
    </section>
    <?php
    	$sql = "SELECT * FROM `admission_student` where name = '".$_SESSION['first_name']."';";
    ...
    <section class="ftco-section ftco-counter ftco-no-pt ftco-no-pb img" id="section-counter">
    	<div class="container">
    		<div class="row d-md-flex align-items-center justify-content-end">
			          ...
			          <div class="col-md-6 d-flex counter-wrap ftco-animate">
			            <div class="block-18">
			              <div class="text">
			              	<span><?php echo"<img  class='align-items-left' src='data:image/jpeg;base64,".base64_encode($row["image"])."' height='200' width='200px;'>";?></span>
			              	<span class="text-left"><b>Name</b> : <?php echo $row["name"];?></span>
			                <span class="text-left"><b>Father Name</b> : <?php echo $row["fname"];?></span>
			                <span class="text-left"><b>DOB</b> : <?php echo $row["DOB"];?></span>
			                <span class="text-left"><b>Address</b> : <?php echo $row["address"];?></span>
			                <span class="text-left"><b>Mobile No</b> : <?php echo $row["mobileno"];?></span>
			                <span class="text-left"><b>Qualifaction</b> : <?php echo $row["qualification"];?></span>
			          ...
			          <div class="col-md-6 d-flex justify-content-center counter-wrap ftco-animate">
			            <div class="block-18">
			              <div class="text">
			              	<span class="text-left"><b>Admission Date</b> : <?php echo $row["admission_date"];?></span>
