...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">RKCE</a>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Avilable Student</h1>
        </div>
       </div>
      </div>
    </section>
    <?php include("db.php");?>
	 ...
	 <?php
    	// $sql = "SELECT * FROM `admission_student` where name = '".$name."' and sno = '".$rollno."';";
	 		$sql ="SELECT * FROM admission_student where name='$name' and id='$rollno'";
    			...
    			<div class="col-lg-12">
    				<div class="ftco-counter-wrap">
			          ...
			          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
			            <div class="block-18">
			              <div class="text">
			              	<span>In Time</span><hr>
			                <span><?php echo date('d-m-Y H:i:sa');?></span>
			              </div>
			            </div>
			          </div>
			          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
			            <div class="block-18">
			              <div class="text">
			              	<span>Remarks</span><hr>
			                <form action="attupdate.php" method="post">
			                	<input type="hidden" id="star1" value="1">
							    <img src="images/star.png" onmouseover="change(this.id);" id="jsp1" class="jsp" style="height: 50px; width: 50px;">
							    <input type="hidden" id="star2" value="2">
							    <img src="images/star.png" onmouseover="change(this.id);" id="jsp2" class="jsp" style="height: 50px; width: 50px;">
							    <input type="hidden" id="star3" value="3">
							    <img src="images/star.png" onmouseover="change(this.id);" id="jsp3" class="jsp" style="height: 50px; width: 50px;">
							    <input type="hidden" id="star4" value="4">
							    <img src="images/star.png" onmouseover="change(this.id);" id="jsp4" class="jsp" style="height: 50px; width: 50px;">
							    <input type="hidden" id="star5" value="5">
							    <img src="images/star.png" onmouseover="change(this.id);" id="jsp5" class="jsp" style="height: 50px; width: 50px;">
							    <input type="submit" name="update" class="btn btn-warning"> 
			               </form>
			                
			                <?php
								if(isset($_POST['update'])){
									$checked_count = count($_POST['rate']);
									echo $checked_count;
								}
								else{
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="remarks.php" method="post" target="_blank">
              <div class="form-group">
