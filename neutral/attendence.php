      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <form action="remarks.php" method="post" class="bg-primary p-5 contact-form" style="padding-bottom: 20px;">
              <div class="form-group">
                <input type="text"  name="sname"class="form-control" placeholder="Your Name">
              </div>
              <div class="form-group">
                <input type="number" name="rollno" class="form-control" placeholder="Your RollNo">
              </div>
              <div class="form-group">
                <input type="submit" value="Submit" class="btn btn-darken py-3 px-5">
              </div>
            </form>
        </div>
       </div>
