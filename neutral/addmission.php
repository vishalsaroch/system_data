      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
             <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }" style="text-align: center"> Student Addmission</h1>
    ...
    <section class="ftco-about ftco-no-pt ftco-no-pb img ftco-section bg-light" id="about-section">
    	<div class="container">
    		...
    		<div class="col-md-6 col-lg-6 d-flex">
    			<form action="storeImage.php" method="post" class="bg-light p-5 contact-form col-md-12">
	                ...
	                <div class="form-group">
	              	...
	              	<div class="form-group">
	                	...
	                	<select class="form-control" name="qua">
	                		<option>Qualifaction</option>
	                		<option value="10 th" class="form-control">10 TH</option>
	                		<option value="12 th" class="form-control">12 TH</option>
	                		<option value="Graduation" class="form-control">Graduation</option>
	                		<option value="Post Graduaion" class="form-control">Post Graduaion</option>
	                	</select>
	              	</div>
	              	<div class="form-group">
	                	<!-- <label>Cource</label> -->
	                	<select class="form-control" name="Cource">
	                		...
	                		<option value="Basic Computer" class="form-control">Basic Computer</option>
	                		<option value="Advance Excel" class="form-control">Advance Excel</option>
	                		<option value="Telly With GST" class="form-control">Telly With GST</option>
	                		<option value="webtel" class="form-control">Webtel</option>
	                		<option value="Web Expert" class="form-control">Web Expert</option>
	                		<option value="Graphic Designing" class="form-control">Graphic Designing</option>

	                		<option value="Auto Card" class="form-control">Auto Card</option>
	                	</select>
	              	</div>
	                ...
	                <div class="form-group">
	                	<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Photo Upload</button>
					</div>
