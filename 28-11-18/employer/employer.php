...
<?php include("nav.php"); ?>
 <?php 
	...
	else if($_SERVER['SERVER_NAME']=='cogentsol.in')
	{
		...
		// $sql = "INSERT INTO `employer` (`address`, `state`, `industory`, `product`, `Statutory`) VALUES ('$address', '$state', '$industry', '$product', '$statutory')";
	...
	// 	$id = $_GET['edit'];
	// 	$update = true;
	// 	$record = mysqli_query($dbname, "SELECT * FROM employer WHERE id=$id");
	...
	// $address = $_POST['address'];
		...
		$product=$_POST['product'];
		$statutory=$_POST['statutory'];
	mysqli_query($db, "UPDATE employer SET address='$address, state='$state', industory='$industory', product='industory', Statutory='$Statutory' WHERE id=$id");
