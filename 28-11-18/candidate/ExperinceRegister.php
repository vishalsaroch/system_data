...
$dateNow = date("Y/m/d");
$dateNow = time("Y/m/d");
$sql = "INSERT INTO `candidate` (`fname`, 'lname`, emailid`, `mobileno`, 'qualification', 'jobtitle', 'years', 'months' `userid`, `pwd`, `date`) VALUES ('$compName', '$lname', '$userid', '$contactNo', '$userid', '$qual', '$title', '$years', '$months' '$pwd', '$dateNow')";
