...
<?php
	...
	$mobile=$_POST['mobile'];
 	$date=date("Y/m/d");
	$sql = "INSERT INTO `download` (`name`,`email`, `mobile`, `date`) VALUES ('$name', '$email', '$mobile', '$date')";
        ...
        <div class="banner_inner">
            <div class="container">
                <div class="row">
					<script>
						function download() {
						document.getElementById("replace").innerHTML = "Thanks for Download Realkeeper Accounting Software.";
						location='https://www.dropbox.com/s/701auzbihaaat1m/Realkeeper_Setup.exe?dl=1';
						}
					</script>

                    <div class="col-lg-12" style="text-align: center; margin:100px; color: #fff;">
                        <h2 style="font-size: 48px; font-wight: bold;" id="replace"	>
						<div class="btn btn-success">
						<span class="fa fa-download" ><h2 onclick="download()"> Download Now </h2>
						<!-- Thanks for Download Realkeeper Accounting Software -->
						</div>
