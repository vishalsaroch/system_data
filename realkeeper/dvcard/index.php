                ...
                <?php echo "<img class='rounded-circle' src='data:image/jpeg;base64,".base64_encode($row["photo"])."'>";?></a></div>
                  ...
                  <div class="button-container">
                      ...
                      <h5 class="text-light">Share</h5>
                        <a class="btn btn-default btn-round btn-lg btn-icon" href="#"  style="background-color: orange" rel="tooltip" title="Share"><i class="fa fa-share-alt" aria-hidden="true"></i></a>
                        <!-- href="vcard.php?id=1" -->
                      ...
                      <a class="btn btn-default btn-round btn-lg btn-icon" href="#" style="background-color: orange" rel="tooltip" title="Logo"><?php echo "<img  src='data:image/jpeg;base64,".base64_encode($row["logo"])."'>";?></a>
