...
<!-- Mirrored from rn53themes.net/themes/demo/directory/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:04:07 GMT -->
<head>
	<title>PostToo | Create a Account</title>
	<!-- META TAGS -->
	<meta charset="utf-8">
		...
		<div class="container top-search-main">
			<div class="row">
				<div class="ts-menu">
					...
					<div class="ts-menu-4 navbar-right">
						<div class="v3-top-ri">
							<ul>
								<li><a href="user-login/index.php" class="v3-menu-sign"><i class="fa fa-sign-in"></i> login</a> </li>
	...
	<section class="tz-register">
			<div class="log-in-pop">
				...
				<div class="log-in-pop-right">
					...
					<form action="userreg.php" method="post" class="s12" onSubmit = "return checkPassword(this)">
						<div>
						...
						<div>
							<div class="input-field s12">
								<input type="number" name="mobileno" minlength="10" maxlength="10" class="validate" required>
						...
						<div>
							<div class="input-field s12"> <a href="#">Forgot password</a> | <a href="user-login/index.php">Login</a> </div>
						</div>
					</form>
				</div>
			</div>
...
<!-- Mirrored from rn53themes.net/themes/demo/directory/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:04:08 GMT -->
</html>