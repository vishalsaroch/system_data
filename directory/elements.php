...
<!-- Mirrored from rn53themes.net/themes/demo/directory/elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:05:47 GMT -->
<head>
	...
	<section class="p-about com-padd com-padd-redu-bot1">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="pg-elem">
						<h3>Buttons</h3> <span>Local directory is the smartest way to find the best services for all your works</span>
						<div class="pg-elem-inn ele-btn"> <a class="waves-effect waves-light btn">button</a> <a class="waves-effect waves-light btn"><i class="material-icons left">cloud</i>button</a> <a class="waves-effect waves-light btn"><i class="material-icons right">cloud</i>button</a> <a class="waves-effect waves-light btn-large">Button</a> <a class="waves-effect waves-light btn-large"><i class="material-icons left">cloud</i>button</a> <a class="waves-effect waves-light btn-large"><i class="material-icons right">cloud</i>button</a> <a class="btn-large disabled">Button</a> <a class="btn disabled">Button</a> <a class="btn-flat disabled">Button</a> <a class="btn-floating disabled"><i class="material-icons">add</i></a> </div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="pg-elem">
						<h3>Form Input fields</h3> <span>Local directory is the smartest way to find the best services for all your works</span>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="pg-elem">
						<h3>Collapsible</h3> <span>Local directory is the smartest way to find the best services for all your works</span>
				...
				<div class="col-md-6">
					<div class="pg-elem">
						<h3>Popout Collapsible</h3> <span>Local directory is the smartest way to find the best services for all your works</span>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="pg-elem">
						<h3>Pre Loading</h3> <span>Local directory is the smartest way to find the best services for all your works</span>
						<div class="pg-elem-inn ele-btn">
				...
				<div class="col-md-6">
					<div class="pg-elem">
						<h3>Pre loading Flashing Colors</h3> <span>Local directory is the smartest way to find the best services for all your works</span>
						<div class="pg-elem-inn ele-btn">
							<div class="preloader-wrapper big active">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="pg-elem icon-container">
						<h3>Materialize icons</h3> <span>Local directory is the smartest way to find the best services for all your works</span>
						<br>
						<br>
