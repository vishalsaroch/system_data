...
<!-- Mirrored from rn53themes.net/themes/demo/directory/admin-setting.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:07:40 GMT -->
<head>
			...
			<div class="sb2-2">
				...
				<div class="tz-2 tz-2-admin">
					<div class="tz-2-com tz-2-main">
						<h4>Admin Setting</h4> <a class="dropdown-button drop-down-meta drop-down-meta-inn" href="#" data-activates="dr-list"><i class="material-icons">more_vert</i></a>
