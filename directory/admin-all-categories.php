			...
			<div class="sb2-2">
				...
				<div class="tz-2 tz-2-admin">
					<div class="tz-2-com tz-2-main">
						<h4>All Categories</h4> <a class="dropdown-button drop-down-meta drop-down-meta-inn" href="#" data-activates="dr-list"><i class="material-icons">more_vert</i></a>
													...
													<?php
                										...
                										if ($result->num_rows > 0) {
                  											while($row = $result->fetch_assoc()) {
                  												echo "<tr>";
                    											echo '<td>' . $row["id"]. '</td>';
                    											echo "<td><span class='list-img'><img src='data:image/jpeg;base64,".base64_encode($row["image"])."' height='100' width='100px;'></span></td>";
                    											echo '<td>' . $row["name"]. '</td>';
                    											echo "</tr>";
                    								?>		
                   									<?php
