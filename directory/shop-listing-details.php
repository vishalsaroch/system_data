...
<!-- Mirrored from rn53themes.net/themes/demo/directory/shop-listing-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:05:47 GMT -->
<head>
...
<body>
	...
	<!--LISTING DETAILS-->
	<section class="pg-list-1 pg-list-shop">
		<div class="container">
			<div class="row">
				<div class="pg-list-1-left"> <a href="#"><h3>Spicy Supermarket Shop</h3></a>
					...
					<div class="list-pg-lt list-page-com-p">
						...
						<div class="pglist-p1 pglist-bg pglist-p-com">
							<div class="pglist-p-com-ti">
								<h3><span>About</span> Spicy Supermarket</h3> </div>
						...
						<div class="pglist-p2 pglist-bg pglist-p-com">
							...
							<div class="list-pg-inn-sp">
								...
								<div class="row pg-list-ser">
									<ul>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/sp1.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Grocery</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/sp2.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Healthy Foods</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/sp3.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Ice Cream</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/sp4.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Fresh Vegetables</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/sp5.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Non veg items</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/sp6.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Chocolate</h4> </div>
										</li>
									</ul>
							...
							<div class="list-pg-inn-sp">
								<div id="myCarousel" class="carousel slide" data-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="item active"> <img src="images/slider/sp1.jpg" alt="Los Angeles"> </div>
										<div class="item"> <img src="images/slider/sp2.jpg" alt="Chicago"> </div>
										<div class="item"> <img src="images/slider/sp3.jpg" alt="New York"> </div>
										<div class="item"> <img src="images/slider/sp4.jpg" alt="New York"> </div>
									</div>
						...
						<div class="pglist-p3 pglist-bg pglist-p-com">
							<div class="pglist-p-com-ti">
								<h3><span>Special</span> Offered Today</h3> </div>
							<div class="list-pg-inn-sp">
								<div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
									<!--LISTINGS IMAGE-->
									<div class="col-md-3"> <img src="images/room/sp1.jpg" alt=""> </div>
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta"> <a href="#!"><h3>10% Offers for all items today only</h3></a>
										...
										<div class="list-room-type list-rom-ami">
											<ul>
												...
												<li><img src="images/icon/a7.png" alt=""> chocolate</li>
												<li><img src="images/icon/a4.png" alt=""> Beer </li>
												<li><img src="images/icon/a3.png" alt=""> Flour</li>
												<li><img src="images/icon/a2.png" alt=""> Mustard</li>
												<li><img src="images/icon/a5.png" alt=""> Pasta</li>
												<li><img src="images/icon/a6.png" alt=""> Pretzels</li>
												<li><img src="images/icon/a9.png" alt=""> Tomato Sauce</li>
												<li><img src="images/icon/a10.png" alt=""> Tomato Sauce</li>
											</ul>
										</div> <span class="home-list-pop-rat list-rom-pric">10%Off</span>
								...
								<div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
									<!--LISTINGS IMAGE-->
									<div class="col-md-3"> <img src="images/room/sp2.jpg" alt=""> </div>
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta"> <a href="#!"><h3>Canned & Packaged Foods</h3></a>
										...
										</div> <span class="home-list-pop-rat list-rom-pric">15%Off</span>
										<div class="list-enqu-btn">
											<ul>
												<li><a href="#!"><i class="fa fa-usd" aria-hidden="true"></i> Get Quotes</a> </li>
												<li><a href="#!"><i class="fa fa-commenting-o" aria-hidden="true"></i> Send SMS</a> </li>
								...
								<div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
									<!--LISTINGS IMAGE-->
									<div class="col-md-3"> <img src="images/room/sp3.jpg" alt=""> </div>
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta"> <a href="#!"><h3>Frozen Foods</h3></a>
										...
										</div> <span class="home-list-pop-rat list-rom-pric">25%Off</span>
										<div class="list-enqu-btn">
											<ul>
												<li><a href="#!"><i class="fa fa-usd" aria-hidden="true"></i> Get Quotes</a> </li>
												<li><a href="#!"><i class="fa fa-commenting-o" aria-hidden="true"></i> Send SMS</a> </li>
...
<!-- Mirrored from rn53themes.net/themes/demo/directory/shop-listing-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:06:45 GMT -->
</html>