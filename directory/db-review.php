...
<!-- Mirrored from rn53themes.net/themes/demo/directory/db-review.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:07:35 GMT -->
<head>
			...
			<div class="tz-l">
				...
				<div class="tz-l-2">
					<ul>
						...
						<li>
							<a href="db-review.php" class="tz-lma"><img src="images/icon/dbl13.png" alt="" /> Reviews(05)</a>
						</li>
						<li>
					...
					<div class="db-list-com tz-db-table">
						...
						<div class="tz-mess">
							<ul>
								...
								<li class="view-msg">
									<h5><img src="images/users/1.png" alt="" />Joseph <span class="tz-revi-star"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i></span></h5>
									<p>Etiam maximus enim odio, vitae malesuada lacus aliquet non. Ut iaculis orci sed velit convallis, non vulputate turpis euismod.Etiam condimentum sagittis pulvinar. Morbi porttitor, sapien vel feugiat sagittis, eros justo molestie urna, sed luctus lectus ipsum quis lorem.</p>
									<div class="hid-msg"><a href="#!"><i class="fa fa-check" title="approve this review"></i></a><a href="#!"><i class="fa fa-edit" title="edit"></i></a><a href="#!"><i class="fa fa-trash" title="delete"></i></a><a href="#!"><i class="fa fa-reply edit-replay" title="replay"></i></a>
										<form class="col s12 hide-box">
											<div class="">
												<div class="input-field col s12">
								...
								<li class="view-msg">
									<h5><img src="images/users/1.png" alt="" />Zachary <span class="tz-revi-star"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i></span></h5>
						...
						<div class="db-mak-pay-bot">
							<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters</p> <a href="db-setting.php" class="waves-effect waves-light btn-large">my settings</a> </div>
					</div>
				</div>
			</div>
			<!--RIGHT SECTION-->
