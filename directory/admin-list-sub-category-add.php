...
<!-- Mirrored from rn53themes.net/themes/demo/directory/admin-list-category-add.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:08:17 GMT -->
<head>
				          ...
				          if(isset($_POST['add'])){
							 ...
							 $result1 = $conn->query($sql);
							  if ($result1->num_rows > 0) {
							  	echo "<div class='bg-danger text-center text-bold' style='font-size:26px; color:#fff'> Sub-Categories is Already exist.<div>";		
							  } else {
				             $query = "INSERT INTO `sub-categories` (`name`, `image`, catid) VALUES ('".$name."', '".$image."', '".$catid."')";
							  	// $query = "INSERT INTO `sub-categories` (`name`) VALUES ('".$name."')";
				              $run = mysqli_query($conn, $query);
				              if($run){
				                 echo "New Sub Categories added sucessfully";
									...
									<div class="tab-inn ad-tab-inn">
										<div class="tz2-form-pay tz2-form-com">
											<form action="" method="post" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="input-field col s12">
														<?php
							                              ...
							                              <input list="Category" name="Category" placeholder="Category" class="validate">
												...
												<div class="row">
													<div class="input-field col s12">
														<input type="submit" name="add" value="SUBMIT" class="waves-effect waves-light full-btn"> </div>
												</div>
											</form>
										</div>
									</div>
