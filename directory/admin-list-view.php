...
<!-- Mirrored from rn53themes.net/themes/demo/directory/admin-list-view.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:08:23 GMT -->
<head>
										...
										<table class="responsive-table bordered">
											<tbody>
												<tr>
													<td>Listing</td>
													<td>:</td>
													<td>Property Luxury Homes</td>
												</tr>
												<tr>
													<td>Location</td>
													<td>:</td>
													<td>Illunois, United States</td>
												</tr>
												<tr>
													<td>Eamil</td>
													<td>:</td>
												...
												<tr>
													<td>Listing Type</td>
													<td>:</td>
													<td><span class="label label-danger">Premium</span>
													</td>
												</tr>
												<tr>
													<td>Status</td>
