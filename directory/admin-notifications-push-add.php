...
<!-- Mirrored from rn53themes.net/themes/demo/directory/admin-notifications-push-add.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:08:17 GMT -->
<head>
			...
			<div class="sb2-2">
				...
				<div class="sb2-2-2">
					<ul>
						...
						<li class="active-bre"><a href="#"> Add Push Notifications</a> </li>
						<li class="page-back"><a href="#"><i class="fa fa-backward" aria-hidden="true"></i> Back</a> </li>
					</ul>
				</div>
				<div class="tz-2 tz-2-admin">
					<div class="tz-2-com tz-2-main">
						<h4>Push Notifications</h4> <a class="dropdown-button drop-down-meta drop-down-meta-inn" href="#" data-activates="dr-list"><i class="material-icons">more_vert</i></a>
