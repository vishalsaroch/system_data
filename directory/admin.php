...
<!-- Mirrored from rn53themes.net/themes/demo/directory/admin.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:07:37 GMT -->
<head>
	...
	<div class="container-fluid sb1">
		<div class="row">
			...
			<div class="col-md-2 col-sm-3 col-xs-6 sb1-1"> <a href="#" class="btn-close-menu"><i class="fa fa-times" aria-hidden="true"></i></a> <a href="#" class="atab-menu"><i class="fa fa-bars tab-menu" aria-hidden="true"></i></a>
				<a href="index-1.php" class="logo"><img src="images/logo2.png" alt="" /> </a>
			</div>
			<!--== SEARCH ==-->
			...
			<div class="col-md-2 col-sm-3 col-xs-6">
				...
				<ul id='top-menu' class='dropdown-content top-menu-sty'>
					...
					<li class="divider"></li>
					<li><a href="admin/logout.php" class="ho-dr-con-last waves-effect"><i class="fa fa-sign-in" aria-hidden="true"></i> Logout</a> </li>
				</ul>
			</div>
		</div>
	</div>
									...
									<div class="tab-inn">
										<div class="table-responsive table-desi">
											<table class="table table-hover">
												...
												// $sql = "SELECT post.title, post.userid, post.price, post.categories, post.image, post.Year, post.Location, post.marks, post.userid, user.userid FROM post INNER JOIN user ON post.userid = user.email";
						                          $result = $conn->query($sql);
						                          while($row = $result->fetch_assoc()) {
						                        ?>
												<tbody>
													<tr>
														<td><span class="list-img"><?php echo "<img class='rounded-circle' src='data:image/jpeg;base64,".base64_encode($row["image1"])."' height='100' width='100px;'>"?></span> </td>
														<td><a href="#"><span class="list-enq-name"><?php echo $row["title"]; ?></span><span class="list-enq-city"></span></a> </td>
											...
											<table class="table table-hover">
												...
												<tbody>
													<tr>
														<td>
															<span class="list-img">
																<!-- <?php echo "<img class='rounded-circle' src='data:image/jpeg;base64,".base64_encode($row["image"])."' height='100' width='100px;'>"?> -->
																<?php
										                          if($row["image"]==="")
										                            echo "<img class='rounded-circle' src='images/users/2.png' height='100' width='100px'>" ;
										                            else
														...
														<td><a href="#"><span class="list-enq-name"><?php echo $row["name"]; ?></td>
														<td><?php echo $row["mobile"]; ?></td>
														<td><?php echo $row["email"]; ?></td>
														<td><?php echo $row["date"]; ?></td>
														<td>
															<?php
										                          if($row["Premium_Account"]==="")
										                            echo "<span class='label label-warning'>NON PRIME USER</span>" ;
										                            else
										                            echo "<span class='label label-success'>PRIME USER</span>";
											                    ?>
														</td>
														<!-- <td> <span class="label label-warning">Un Read</span> </td>
...
<!-- Mirrored from rn53themes.net/themes/demo/directory/admin.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:07:39 GMT -->
</html>