...
<!-- Mirrored from rn53themes.net/themes/demo/directory/admin-login.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:08:17 GMT -->
<head>
...
<body>
	...
	<section class="tz-login">
		<div class="tz-regi-form">
			...
			<form class="col s12" action="admin-login.php">
				<div class="row">
