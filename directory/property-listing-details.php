...
<!-- Mirrored from rn53themes.net/themes/demo/directory/property-listing-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:06:45 GMT -->
<head>
...
<body>
	...
	<section class="pg-list-1 pg-list-prop">
		<div class="container">
			<div class="row">
				<div class="pg-list-1-left"> <a href="#"><h3>American Luxury Property</h3></a>
					...
					<div class="list-number pag-p1-phone">
						<ul>
							<li><i class="fa fa-phone" aria-hidden="true"></i> +01 6541 3214</li>
							<li><i class="fa fa-envelope" aria-hidden="true"></i> propert@webdir.com</li>
						...
						<div class="pglist-p2 pglist-bg pglist-p-com">
							...
							<div class="list-pg-inn-sp">
								...
								<div class="row pg-list-ser">
									<ul>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/p1.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Luxury Villas</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/p2.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Apartments/Flats</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/p3.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Individual Houses</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/p4.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Plots & Land</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/p5.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Elite Apartments</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/p6.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Property Buy & Sell</h4> </div>
										</li>
									</ul>
								</div>
							</div>
...
<!-- Mirrored from rn53themes.net/themes/demo/directory/property-listing-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:07:32 GMT -->
</html>