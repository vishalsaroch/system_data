...
<!-- Mirrored from rn53themes.net/themes/demo/directory/db-all-listing.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:07:35 GMT -->
<head>
			...
			<div class="tz-l">
				...
				<div class="tz-l-2">
					<ul>
						...
						<li>
							<a href="db-all-listing.php" class="tz-lma"><img src="images/icon/dbl11.png" alt="" /> All Posted Ads</a>
						</li>
						<li>
				...
				<div class="tz-2-com tz-2-main">
					...
					<div class="db-list-com tz-db-table">
						...
						<table class="responsive-table bordered">
							...
							<?php
								$sql = "SELECT * from post where post.userid = '".$_SESSION['email']."';";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) {
								while($row = $result->fetch_assoc()) {
							?>
							<tbody>
								<tr>
									...
									<td>
										<!-- <a href="db-listing-edit.php id" class="db-list-edit">Edit</a> -->
										<a href="db-listing-edit.php?id=<?php echo $row["id"];?>" target="-blank">Edit</a>
									</td>
								</tr>
							</tbody>
							<?php
