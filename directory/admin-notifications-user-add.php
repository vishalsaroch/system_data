...
<!-- Mirrored from rn53themes.net/themes/demo/directory/admin-notifications-user-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2019 07:08:17 GMT -->
<head>
	...
	<div class="container-fluid sb1">
		<div class="row">
			...
			<div class="col-md-2 col-sm-3 col-xs-6 sb1-1"> <a href="#" class="btn-close-menu"><i class="fa fa-times" aria-hidden="true"></i></a> <a href="#" class="atab-menu"><i class="fa fa-bars tab-menu" aria-hidden="true"></i></a>
				<a href="index-1.html" class="logo"><img src="images/logo1.png" alt="" /> </a>
			</div>
			<!--== SEARCH ==-->
