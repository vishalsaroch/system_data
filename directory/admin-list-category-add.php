					...
					<div class="tz-2-com tz-2-main">
						...
						<?php
				          if(isset($_POST['add'])){
				            ...
				            $sql = "SELECT * from `Categories`  where Categories.name = '".$name."';";
				            $result1 = $conn->query($sql);
							  if ($result1->num_rows > 0) {
							  	echo "<div class='bg-danger text-center text-bold' style='font-size:26px;>Categories is Already exist.<div>";		
							  } else {
				             $query = "INSERT INTO `Categories` (`name`, `image`) VALUES ('".$name."', '".$image."')";
				              $run = mysqli_query($conn, $query);
				              if($run){
				                 echo "New Categories added sucessfully";
											...
											<form action="" method="post" enctype="multipart/form-data">
												<div class="row">
													<div class="input-field col s12">
														<input type="text" class="validate" name="catname">
