...
<html lang="en">
  <head>
    ...
    <script>
      function seeMoreData(element){
        var productname=element.childNodes[1].innerHTML;
        // alert(productname);
        if(location.hostname=='localhost')
          {
            window.open("/shop/fileterservice.php?name="+productname.toString());
          }
          else if(location.hostname=='truelook.in')
          {
            window.open("fileterservice.php?name="+productname.toString());
          }
      }
    </script>
  </head>
  ...
  <div class="container">
    <div class="row">
     <div class="col-md-12 bg-white">
      ...
      <?php
        ...
        $sql = "SELECT * from services WHERE `for`='man'";
    ...
    <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5" style="float:left;" >
      ...
      <?php 
        if($row["image"]===""){
          echo "<div onclick='seeMoreData(this.parentNode);'><img src='images/module.png' height='150' width='150px' data-toggle='modal'> <h3 class='text-black h4' style='display : none'>$service</h3></div>";}
          else{
          echo "<div onclick='seeMoreData(this.parentNode);'><img src='data:image/jpeg;base64,".base64_encode($row["image"])."' height='150' data-toggle='modal'> <h3 class='text-black h4' style='display : none'></div>";
        }
      ?>
        <br>
      <h3 class="text-black h4" onclick="seeMoreData(this.parentNode);" ><?php echo $service;?></h3>
     </div>
      </div>
      <?php
        }
