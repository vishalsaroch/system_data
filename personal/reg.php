					...
					<div class="col-md-10">
						...
						<div class="col-md-12">
							<form class="" action="" method="post">
								...
								<div class="form-group">
									<input type="text" name="name" placeholder="Conform Password" class="form-control">
								</div>
								<div class="form-group">
									<input type="submit" name="register" value="Register"  class="form-control" style="background-color: #f45042; color: #fff">
								</div>
							</form>
							...
							<ul class="fh5co-social">
								<li><a href="#"><i class="icon-phone"><br>Call Me</i></a></li>
								<li><a href="#"><i class="icon-whatsapp"><br>Whatsaap</i></a></li>
								<li><a href="#"><i class="icon-envelope"><br>Email</i></a></li>
								<li><a href="#"><i class="icon-twitter"><br>Twitter</i></a></li>
								<li><a href="#"><i class="icon-skype"><br>Skype</i></a></li>
								<li><a href="#"><i class="icon-linkedin"><br>Linkedin</i></a></li>
							</ul>
							<hr>
							<ul class="fh5co-social">
