...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<div id="fh5co-main" style="background-color: #f48642">
					...
					<div class="row row-bottom-padded-sm">
						<div class="col-md-12">
							...
							<ul class="fh5co-social">
								<li><a href="#"><i class="icon-phone" style="font-size: 35px;"></i><br><span>Call Me</span></a></li>
								<li><a href="#"><i class="icon-whatsapp" style="font-size: 35px;"></i><br><span>Whatsaap</span></a></li>
								<li><a href="#"><i class="icon-envelope" style="font-size: 35px;"></i><br><span>Email</span></a></li>
								<li><a href="#"><i class="icon-facebook" style="font-size: 35px;"></i><span><br>Facebook</span></a></li>
								<li><a href="#"><i class="icon-skype" style="font-size: 35px;"></i><span><br>Skype</span></a></li>
								
								<li><a href="#"><i class="icon-linkedin" style="font-size: 35px;"></i></a><span><br>Linkedin</span></li>
								<li><a href="#"><i class="icon-download" style="font-size: 35px;"></i><span><br>Save Me</span></a></li>
							</ul>
							<hr>
							<ul class="fh5co-social">
								<li><a href="#"><i class="icon-share"><br>Share</i></a></li>
							</ul>
							<hr>
							<ul class="fh5co-social">
								<li><a href="#"><i class="icon-company">Company : </i></a></li>
								<li><a href="#"><i class="icon-website">Website : </i></a></li>
							</ul>
