                    ...
                    <div class="box-body" >
                      ...
                      <form action="" method="post" role="form" id="form" style="border:1px solid orange; padding:5% 5% 0 5%; margin-top:10px;" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-6 form-group">
                            <label>Attender <span>*</span></label>
                        ...
                        <div class="row">
                          <div class="col-xs-4 form-group has-warning">
                            ...
                            <select class="form-control input-sm status" id="type" name="job[type]" required>
                              ...
                              <?php if($_SESSION['SESS__azz_level'] > 7) echo '<option value="Other">Admin Force Close</option>'; ?>
                            </select>
                          </div>
            ...
            if (type === 'Onsite') {
              ...
              $('#optionSection').append(
                  '<div class="col-xs-4 form-group has-warning">'+
                    ...
                    '<input type="text" class="form-control input-sm" name="job[km_run]" min="0" max="200" step="0.01" placeholder="KM Run" required=""/>'+
                  '</div>'+
                  '<div class="col-xs-4 form-group has-warning" title="Time to Follow / Turn Arround TIme">'+
                    '<label>OTP <span>*</span></label>'+
                    '<input type="text" class="form-control input-sm" name="otp" maxlength="4" pattern="[0-9]{4}"  placeholder="Customer OTP" required="" />'+
                  '</div>'+
