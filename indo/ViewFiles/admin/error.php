...
<head>
    ...
    <!-- PAGE LEVEL STYLES -->
    <link href="<?php echo CDN_ADMIN; ?>/css/error.css" rel="stylesheet" />
   <link href="<?php echo CDN_ADMIN; ?>/plugins/magic/magic.css" rel="stylesheet" />
...
<body >
  <!--  PAGE CONTENT -->
	  ...
	  <div class="logo">
	    <h1>Page Under Development</h1>          </div>
		  ...
		  <div class="btn-group btn-group-justified">
		      <a href="/shoppo-admin" class="btn btn-primary">Return Dashboard</a>
