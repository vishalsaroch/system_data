...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    /*#basic tr:hover {background-color: #ddd;}
    */
    #basic th {
       /* padding-top: 12px;
        padding-bottom: 12px;*/
  ...
  <nav class="navbar navbar" style="height: 100px; background-color: black; color: white;" >
      <div class="container-fluid">
       ...
       <ul class="nav navbar-nav">
            ...
            <li><a href="jobshow.php">My Jobs</a></li>
        </ul>
  ...
  <div class="modal-content">
    ...
    <form method="post" action="">
       <table id="basic" style=" border-collapse:separate; border-spacing:20px;">
        <tr><h3 align="center">Basic Information</h3></tr>
...
$sql = "INSERT INTO `basicinformation` (`FatherName`, `DOB`, `CurrentDesignation`, `CurrentLocation`,`  Address`, ` Religion`, `  Nationality`, `LanguageKnown`, `PreferredLocation`, ` NoticePeriod`,` ExpectedSalary`) VALUES ('$fname1', '$dob', '$matrical', '$designation', '$clocation', '$address', '$relign', '$nationality', '$language', '$plocation', '$notice', '$salary')";
