...
<?php 
  ...
  <?php include("nav.php"); ?>
    <div class="container">
      ...
      <div class="col-lg-2">
       <div id="list"></div>
            <form id="theForm" action="" method="post" enctype="multipart/form-data" style="margin-top: 50px;">
             
              <input type="file" name="fileToUpload" id="fileToUpload"  align="right" style="margin-top: 20px;">
              <input type="submit" value="Upload Image" name="submit" class="btn btn-info" style="width: 100px;">
            </form>
            <img src="candidateImage/11.jpg" height="100px;" width="100px";>
          </div>
        <div class="col-lg-12">
