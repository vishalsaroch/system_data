                        ...
                        <?php
                            ...
                            else if($_SERVER['SERVER_NAME']=='cogentsol.in')
                            {
                                ...
                                if(isset($_POST['submit'])){
                                 ...
                                 $query = "INSERT INTO `job` (`jobTitle`, `jobType`, `city`,  `Industry`, `Function/Dept`, `Qualification`, `Nationality`, `year`, `month`, `description`, `email`, `mobileno`, `date`, `userid`) VALUES ('".$jobTitle."', '".$jobType."', '".$city."',  '".$industry."', '".$role."', '".$qualifation."', '".$nationality."', '".$year."', '".$month."', '".$description."', '".$emailid."', '".$mobileno."', '".$dateNow."', '".$email."')";
