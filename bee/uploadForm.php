...
$cdate= date("Y/m/d");
echo $cdate;
$sql = "INSERT INTO `form` (`hname`, `hgender`, `hage`, `fathorhusb`, `hfather`, `haddress`, `hdoor`, `hstreet`, `hcity`, `hstate`, `yearsinD`, `bankAcc`, `hmobile`, `hotherid`, `haadhar`, `hdisability`, `hmarried`, `hrent`, `hincome`, `name1`, `relation1`, `gender1`, `age1`, `aadhar1`, `otherid1`, `otheridno1`, `name2`, `relation2`, `gender2`, `age2`, `aadhar2`, `otherid2`, `otheridno2`, `name3`, `relation3`, `gender3`, `age3`, `aadhar3`, `otherid3`, `otheridno3`, `name4`, `relation4`, `gender4`, `age4`, `aadhar4`, `otherid4`, `otheridno4`, `name5`, `relation5`, `gender5`, `age5`, `aadhar5`, `otherid5`, `otheridno5`, `cdate`) VALUES ('".$hname."', '".$hgender."', '".$hage."', '".$fathorhusb."', '".$hfather."', '".$haddress."', '".$hdoor."', '".$hstreet."', '".$hcity."', '".$hstate."', '".$yearsinD."', '".$bankAcc."', '".$hmobile."', '".$hotherid."', '".$haadhar."', '".$hdisability."', '".$hmarried."', '".$hrent."', '".$hincome."', '".$name1."', '".$relation1."', '".$gender1."', '".$age1."', '".$aadhar1."', '".$otherid1."', '".$otheridno1."', '".$name2."', '".$relation2."', '".$gender2."', '".$age2."', '".$aadhar2."', '".$otherid2."', '".$otheridno2."', '".$name3."', '".$relation3."', '".$gender3."', '".$age3."', '".$aadhar3."', '".$otherid3."', '".$otheridno3."', '".$name4."', '".$relation4."', '".$gender4."', '".$age4."', '".$aadhar4."', '".$otherid4."', '".$otheridno4."', '".$name5."', '".$relation5."', '".$gender5."', '".$age5."', '".$aadhar5."', '".$otherid5."', '".$otheridno5."', '".$cdate."');";
