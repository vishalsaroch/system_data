...
<div class="container-fluid text-center" style="margin-top:100px;">    
  <div class="row">
  <!-- <div class="col-md-12">
    <img src="images/background1.jpg" width="100%" height="300px;" class="img-responsive">
  </div> -->
...
<?php
    ...
    <?php
        ...
        $sql = "SELECT * FROM job WHERE `Industry`='Education, Teaching, Training' order by sno desc";
      // $sql = "SELECT * FROM job order by sno desc";
        ...
        echo "</div>";
              ...
              echo "<div style='height:30vw; width:30vw; text-align:center margin:100px;>No Result found</div>";
          }
           $conn->close();
      ?> 
    </div>
