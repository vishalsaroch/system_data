		...
		else if($_SERVER['SERVER_NAME']=='cogentsol.in')
		{
			...
			if ($conn->connect_error) {
				...
				if ($result1->num_rows > 0) {
				    // output data of each row
				    echo "<table class='table'><tr><th>qualifaction</th><th>courses/programs</th><th>specialization</th><th>industry</th><th>Department</th><th>state</th><th>locaation</th></tr>";
