          ...
          if ($result1->num_rows > 1) {
            ...
            while($row = $result1->fetch_assoc()) {
              ...
              <td align = 'center' onclick='seeMoreData1(this.parentNode);'>
                  ...
                  echo "<tr> <td>000" . $row["sno"]. "</td> <td> " . $row["compName"]. "</td> <td> " . $row["jobTitle"]. "</td> <td> " . $row["jobType"]. "</td>
               <td align = 'center' onclick='seeMoreData1(this.parentNode);'>
                        <span  id='view' class='glyphicon glyphicon-eye-open' aria-hidden='true'></span>
                      </td>
                      <td onclick='deleteData1(this.parentNode);'>
                  ...
                  echo "<tr><td> " . $row["sno"]. "</td> <td> " . $row["compName"]. "</td> <td> " . $row["jobTitle"]. "</td> <td> " . $row["contactNo"]. "</td>
                <td align = 'center' onclick='seeMoreData1(this.parentNode);'>
                        <span  id='view' class='glyphicon glyphicon-eye-open' aria-hidden='true'></span>
                      </td>
                      <td onclick='deleteData1(this.parentNode);'>
