  ...
  <div class="container">
    <div class="row">
     <div class="col-md-12 bg-white">
      ...
      // $sql = "SELECT shop.name, shop.location, shop.line1, shop.line2,  updateservices.pname, updateservices.price, updateservices.image, updateservices.mobileno FROM shop INNER JOIN updateservices ON shop.userid = updateservices.userid where updateservices.pname = '".$name"';";
        // $sql = "SELECT shop.name, shop.location, shop.line1, shop.line2,  updateservices.pname, updateservices.price, updateservices.image, updateservices.mobileno FROM shop INNER JOIN updateservices ON shop.userid = updateservices.userid";
         // $sql = "SELECT * FROM `services` where pname = '".$name."';"
      ...
      <?php
                // $sql = "SELECT * FROM userserviseupdate WHERE userserviseupdate.emailid = '".$_SESSION['email']."';";
