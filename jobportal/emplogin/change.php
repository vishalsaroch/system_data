...
if($_SERVER['SERVER_NAME']=='localhost'){
  ...
  if (count($_POST) > 0) {
    $result = mysqli_query($conn, "SELECT * from employersusers WHERE userid='" . $email . "'");
    $row = mysqli_fetch_array($result);
    if ($_POST["currentPassword"] == $row["pwd"]) {
      mysqli_query($conn, "UPDATE employersusers set pwd='" . $_POST["newPassword"] . "' WHERE userId='" . $email . "'");
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row"  style="height: 420px;">
              <div class="col-lg-6 d-none d-lg-block"><img src="../images/emp.jpg" style="height: 100%;width: 100%"></div>
