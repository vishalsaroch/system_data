    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-9">
            <p><span>Address:</span> Rohini, Delhi</p>
          </div>
          
          <div class="col-md-3">
            <p><span>Email:</span> <a href="info@cogentsol.in">info@cogentsol.in</a></p>
          </div>
          <!-- <div class="col-md-3">
            <p><span>Website</span> <a href="#">sunder.jangir@gmail.com</a></p>
          </div> -->
        </div>
