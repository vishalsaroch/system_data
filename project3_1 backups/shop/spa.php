...
<html lang="en">
  ...
  <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover inner-page-cover" style="background-image: url(images/banner-med1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">

            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              <h2 class="text-white font-weight-light mb-2 display-1">Spa Services!</h2>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              ...
              <img src="images/spa/aa.jpg" style="height: 300px; width: 270px;">
              <!-- <h3 class="text-black h4">Bleaching Service</h3> --><br>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              ...
              <img src="images/spa/Back.jpg" style="height: 300px; width: 270px;">
              <!-- <h3 class="text-black h4">Body waxing</h3> -->
              <br>
              <p><a href="booking.php" class="btn btn-black py-3 px-5">Book Now!</a></p>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
            <img src="images/spa/a1.jpg" style="height: 300px; width: 270px;">
              <!-- <span class="icon flaticon-shave display-3 text-primary mb-4 d-block"></span> -->
              <!-- <h3 class="text-black h4">Bridal</h3> -->
              <br>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              ...
              <img src="images/spa/couples.jpg" style="height: 250px; width: 250px;">
              <br><br>
             <!--  <h3 class="text-black h4">Face threading</h3> -->
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
             ...
             <img src="images/spa/3.jpg" style="height: 250px; width: 250px;">
             <!--  <h3 class="text-black h4">Facial</h3> -->
             <br><br>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
             ...
             <img src="images/spa/body-spa.jpg" style="height: 250px; width: 250px;">
             <!--  <h3 class="text-black h4">Skin Care Treatment</h3> -->
              <br><br>              
              <p><a href="booking.php" class="btn btn-black py-3 px-5">Book Now!</a></p>
