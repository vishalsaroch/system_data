        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="col-md-6" data-aos="fade-up" data-aos-delay="400" style="background-color: #fff; opacity: 0.7">
              <h2 class="text-black font-weight-light mb-2 display-1">User Login</h2>
                <form action="index.php" method="post" align="center" style="padding-right:10px">
                  <input type="text" name="mobile" placeholder="username" style="margin: 10px;"><br>
                  <input type="password" name="password" placeholder="password" style="margin: 10px;"><br>
                  <!-- <button>login</button> -->
                  <input type="submit" name="login" value="login" align="left" class="btn btn-success" style="margin:10px;"><br>
                  Not registered? <a href="../addshop.php">Create an account</a><br>
