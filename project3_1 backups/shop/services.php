        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
             <img src="images/hairstyle/A.jpg" style="height: 250px; width:250px;">
             <br><br>
              <h3 class="text-black h4">Hair Cutting</h3>
              <!-- <br>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              <img src="images/hairstyle/0007424.jpeg" style="height:250px; width: 250px;">
              <br><br>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              <img src="images/hairstyle/purple.jpg" style="height: 250px; width: 250px;">
              <br><br>
              <h3 class="text-black h4">Barber Shave</h3>
              <!-- <br>
              <p><a href="booking.php" class="btn btn-black py-3 px-5">Book Now!</a></p> -->
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              <img src="images/hairstyle/Beauty-salon.jpg" style="height: 250px; width: 250px;">
              <br><br>
              <h3 class="text-black h4">Facial for Men</h3>
              <!-- <br>
              <p><a href="booking.php" class="btn btn-black py-3 px-5">Book Now!</a></p> -->
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              <img src="images/hairstyle/New-hairstyle.jpg" style="height: 250px; width:250px;">
              <br><br>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              <img src="images/hairstyle/13.jpg" style="height: 250px; width: 250px;">
              <br><br>
