	...
	<div class="gtco-section">
		<div class="gtco-container">
			...
			<div class="row">
					...
					$sql = "SELECT packageName, image, packageDurationNight, packageDurationDay, destination1, destination2, destination3, destination4, destination5, destination6, destination7, destination8, destination9, destination10, packageCost from packages where dori=0";
