...
$sql = "SELECT * from packages where sno=".$p;
		...
		if($result->num_rows>0){
			...
			while($row = $result->fetch_assoc()){
				...
				echo "<br><div class='row' style='border: 1px solid grey'>
					...
					echo "<br><br><form id='orderpackage' action='deletepackage.php' method='POST'  style='display: inline;'>
								<input type='text' id='packkk2' name='packiddd' style='display: none;'>
								<input style='margin-left:44%;' type='submit' value='Delete Package' class='btn btn-primary'>
							</form><br><br>
							
							<script>document.getElementById('packkk2').value='".$p."';</script>
							";
			}
		} 
		else {
