            ...
            <div class='menu-sidebar__content js-scrollbar1'>
                <nav class='navbar-sidebar'>
                    <ul class='list-unstyled navbar__list'>
                                ...
                                <li>
                                    <a href='contact.php'><i class='fas fa-tachometer-alt'></i>Contact enquiry</a>
                                </li>
                                <li>
                                    <a href='tour.php'><i class='fas fa-tachometer-alt'></i>Tour enquiry</a>
                                </li>
                                <li>
                                    <a href='updateSite.php'><i class='fas fa-tachometer-alt'></i>Update Site</a>
                                </li>
                                <li>
                                    <a href='customers.php'><i class='fas fa-tachometer-alt'></i>My Customers</a>
                                </li>
                                <li>
                                    <a href='packages.php'><i class='fas fa-tachometer-alt'></i>Tour Packages</a>
                                </li>
